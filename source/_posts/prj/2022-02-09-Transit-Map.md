...
project:
  -
    ...
    description: >-
        ...
        The linked demo is a modified version of the original project (no longer maintained) in collaboration with Etch for Licking County Transit in Ohio.
    client: "City of Lancaster (Employer) | Etch (Freelance)"
---